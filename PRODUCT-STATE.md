...
>
> **Live models:** Alpha `v10.8-alpha-3plus-parlay2v3` (MLB control, no NFL/CFB,
> JS-lock Claude, fill-to-3 at EV>0, 2-or-3 parlay optimizer; CLV/self-opt observer-only, MARKET_UNIT_CAPS, todayET; Alpha results default FULL history, optional ?from=).
> Omega `v11.7-omega-parlay2v3` (fill-to-3 + best-2 vs best-3 parlay compare, football MAIN 1 slot + predCLV ≥ 0,
