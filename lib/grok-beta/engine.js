...
function restDays(playedYesterday) {
  // Observed feature only: 1 if ESPN shows the team on yesterday's slate, else 2 (neutral).
  // Do not invent 3-day rest — that systematically juices NFL/NBA overs on off-days.
