// get-results-beta.js
// API endpoint: GET /.netlify/functions/get-results-beta
// Returns historical picks graded against ESPN final scores — reads from "edge-picks-beta" blob store.
...
exports.handler = async (event) => {
  ...
  try {
    ...
    console.error('[get-results-beta] Error:', err.message);
    return {
      statusCode: 500,
      headers: CORS,
