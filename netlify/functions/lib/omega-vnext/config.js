...
const MODEL_VERSION = 'v12.0.0-omega-vnext-clv';
...
const SHARP_BOOKS = ['pinnacle', 'circa', 'bookmaker', 'betonlineag', 'lowvig'];
const US_BOOKS = [
...
const MODEL_NOTES = [
  'v12.0.0 omega-vnext: clean CLV-first composer; ignores legacy v11 Elo/FIP megascript math.',
  ...
  'Predicted CLV is a proxy (model fair vs sharp mid / best-US vs sharp) — not realized close.',
