// run-guardian.js
// Manual trigger: POST /api/run-guardian?key=YOUR_SECRET
// Triggers the Guardian background digest generation on demand.
...
exports.handler = async (event) => {
  ...
  try {
    ...
    return {
      ...
      body: JSON.stringify({
        success: true,
        message: "Guardian digest generation triggered. Results available in 1-2 minutes at /api/get-guardian",
