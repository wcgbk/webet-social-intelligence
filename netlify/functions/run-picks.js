// run-picks.js
// Manual trigger: POST /.netlify/functions/run-picks?key=YOUR_SECRET
// Triggers the background pick generation function on demand.
...
exports.handler = async (event) => {
  ...
  try {
    ...
    return {
      ...
      body: JSON.stringify({
        success: true,
        message: "Pick generation triggered. Results available in 1-2 minutes at /api/get-picks",
