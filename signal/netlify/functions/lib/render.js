...
function buildCardSVG({ kind = "quote", niche = "quotes", headline = "", sub = "", avatarUri = null }) {
  ...
  <text x="${W / 2}" y="${H - BBAND / 2 + 28}" font-family="DejaVu Sans" font-size="16" font-weight="bold" fill="${MINT}" text-anchor="middle" letter-spacing="2">powered by Authentic Press</text>
</svg>`;
}
