...
(function () {
  ...
  var css = ''
    + '.wbl-overlay{position:fixed;inset:0;z-index:2147483000;display:none;align-items:center;justify-content:center;padding:18px;background:rgba(8,4,20,.72);backdrop-filter:blur(6px);-webkit-backdrop-filter:blur(6px);}'
    + '.wbl-overlay.wbl-open{display:flex;}'
    + '.wbl-card{position:relative;width:100%;max-width:400px;background:hsl(260,40%,8%);border:1px solid rgba(255,255,255,.12);border-radius:18px;padding:26px 24px;box-shadow:0 30px 80px rgba(0,0,0,.55);color:rgba(255,255,255,.92);font-family:"Geist Sans",-apple-system,system-ui,sans-serif;max-height:92vh;overflow-y:auto;}'
    ...
    + '.wbl-logo{display:flex;align-items:center;gap:8px;font-weight:800;font-size:16px;margin-bottom:14px;}'
    + '.wbl-logo svg{width:24px;height:21px;}'
    + '.wbl-h{font-size:21px;font-weight:800;margin:0 0 5px;}'
    + '.wbl-sub{font-size:13px;line-height:1.55;color:rgba(255,255,255,.62);margin:0 0 20px;}'
    + '.wbl-sub b{color:#87fb89;}'
    ...
    overlay = h('<div class="wbl-overlay" role="dialog" aria-modal="true">' +
      '<div class="wbl-card">' +
        ...
        '<div id="wbl-step-phone">' +
          ...
          '<button class="wbl-btn" id="wbl-send" type="button">Text me a code</button>' +
        '</div>' +
        '<div id="wbl-step-code" style="display:none;">' +
          ...
          '<button class="wbl-btn" id="wbl-verify" type="button">Verify &amp; sign in</button>' +
